                    ...
                    <nav className='w-full mt-5 flex'>
                        <ul className="flex flex-col items-start justify-start flex-1 space-y-2 px-4 py-2">
                            <li className='hover:bg-gray-200 w-full'>
                                <Link href="/Dashboard" className="flex block p-2 text-sm font-medium hover:text-gray-600">
                            ...
                            <li className='hover:bg-gray-200 w-full'>
                                  <Link href="/Search" className="flex block p-2 text-sm font-medium hover:text-gray-600">
                            ...
                            <li className='hover:bg-gray-200 w-full'>
                                <Link href="/Profile" className="flex block p-2 text-sm font-medium hover:text-gray-600">
